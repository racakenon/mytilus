...
local function setup(palette)
	...
	return {
		...
		LineNr               = { p.ui.inactive, p.ui.line.side }, --	Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
		...
		ModeMsg              = { p.ui.info },                    --	'showmode' message (e.g., "-- INSERT --").
		...
		Question             = { p.ui.hint },                    --	hit-enter prompt and yes/no questions.
