	...
	local function gen_palette()
		...
		local palette = {
			...
			bg = {
				...
				red        = { bg = c.v2_red },
				orange     = { bg = c.v2_orange },
				yellow     = { bg = c.v2_yellow },
				chartreuse = { bg = c.v2_chartreuse },
				green      = { bg = c.v2_green },
				cyan       = { bg = c.v2_cyan },
				blue       = { bg = c.v2_blue },
				purple     = { bg = c.v2_purple },
			},
			ui = {
				...
				info      = { bg = c.v2_purple },
				hint      = { bg = c.v2_blue },
				select    = { bg = c.d3_orange, fg = c.v1_white },
				candidate = { bg = c.d3_black, fg = c.v1_white },
				cursor    = { fg = c.v1_white, bg = c.d3_black },
				sign      = { fg = c.d3_cyan },
				inactive  = { fg = c.d2_black },
				special   = { fg = c.d1_orange },
				fold      = { fg = c.d2_white },
				nontext   = { fg = c.d3_white },
				pmenu     = { bg = c.v0_black },
				pselect   = { bg = c.v2_orange },
				line      = {
