...
export def main [] {
    return {
        ...
        shape_garbage: { fg: '#D1CFDA' bg: '$(v3_red)' attr: 'b' }
        ...
        shape_raw_string: { fg: '#D1D2C7' attr: 'b' }
        ...
        row_index: { fg: '#C7C8BE' attr: 'b' }
        search_result: { fg: '#E8AF96' bg: '#40422C' }
        separator: '#DBD9E4'
    }
}
