...
export def main [] {
    return {
        ...
        shape_garbage: { fg: '#DBDAE1' bg: '$(v3_red)' attr: 'b' }
        ...
        shape_raw_string: { fg: '#DBDBD4' attr: 'b' }
        ...
        row_index: { fg: '#D4D5CE' attr: 'b' }
        search_result: { fg: '#F6C0A8' bg: '#52534D' }
        separator: '#E1E0E8'
    }
}
